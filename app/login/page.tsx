    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-amber-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2 text-sm">Sign in to save your names and unlock more generations</p>
        </div>

        <div className="bg-amber-50 rounded-xl p-4 mb-6 space-y-2">
          <p className="text-xs font-semibold text-amber-800 uppercase tracking-wide mb-3">Free account includes:</p>
          <div className="flex items-center gap-2 text-sm text-amber-900"><span>✓</span> <span>10 name generations per day</span></div>
          <div className="flex items-center gap-2 text-sm text-amber-900"><span>✓</span> <span>30-day name history</span></div>
          <div className="flex items-center gap-2 text-sm text-amber-900"><span>✓</span> <span>Save up to 5 favorites</span></div>
        </div>
